namespace Tren.Views {
	partial class CentralDeTratamento2View {
		...
		private void InitializeComponent() {
			...
			this.txb_vazaoInfiltracaoFut = new MetroFramework.Controls.MetroTextBox();
			this.txb_vazaoInfiltracao = new MetroFramework.Controls.MetroTextBox();
			this.txb_taxaInfiltracaoFut = new MetroFramework.Controls.MetroTextBox();
			this.txb_taxaInfiltracao = new MetroFramework.Controls.MetroTextBox();
			this.txb_extensaoRede = new MetroFramework.Controls.MetroTextBox();
			...
			this.txb_qpc = new MetroFramework.Controls.MetroTextBox();
			...
			this.txb_vazaoDomesticaFut = new MetroFramework.Controls.MetroTextBox();
			this.txb_vazaoDomestica = new MetroFramework.Controls.MetroTextBox();
			...
			this.lb_extensaoRede.Text = "Extensao da Rede";
			// 
			// txb_qpc
			// 
			...
			this.Controls.Add(this.txb_vazaoDomesticaFut);
			this.Controls.Add(this.txb_vazaoDomestica);
			...
			this.Controls.Add(this.txb_vazaoInfiltracaoFut);
			this.Controls.Add(this.txb_vazaoInfiltracao);
			this.Controls.Add(this.txb_taxaInfiltracaoFut);
			this.Controls.Add(this.txb_taxaInfiltracao);
			this.Controls.Add(this.txb_extensaoRede);
		...
		private MetroFramework.Controls.MetroTextBox txb_vazaoInfiltracaoFut;
		private MetroFramework.Controls.MetroTextBox txb_vazaoInfiltracao;
		private MetroFramework.Controls.MetroTextBox txb_taxaInfiltracaoFut;
		private MetroFramework.Controls.MetroTextBox txb_taxaInfiltracao;
		private MetroFramework.Controls.MetroTextBox txb_extensaoRede;
		...
		private MetroFramework.Controls.MetroTextBox txb_qpc;
		...
		private MetroFramework.Controls.MetroTextBox txb_vazaoDomesticaFut;
		private MetroFramework.Controls.MetroTextBox txb_vazaoDomestica;
